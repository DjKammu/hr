    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
              <div class="row mb-2">
                    <div class="col-6">
                        <h4 class="mt-0 text-left">Add Employee Status</h4>
                    </div>
                </div>
               ...
               <div class="row">
                        <div class="col-md-12">
                            <div class="card-body">
                                <form   method="post" 
                              action="{{ route('employee-status.store') }}">
                                  @csrf
                                    ...
                                    <div class="col-12 text-center">
                                        <button id="change-password-button" type="submit" class="btn btn-danger">Create Employee Status
                                        </button>
                                    </div>
